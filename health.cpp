...
Health::Health() :
  ...
  start(Vector2f(Gamedata::getInstance().getXmlInt("hudDetails/healthLocation/x"),
                 Gamedata::getInstance().getXmlInt("hudDetails/healthLocation/y"))), 
  totalLength(Gamedata::getInstance().getXmlInt("hudDetails/healthDimensions/x")), 
  currentLength(Gamedata::getInstance().getXmlInt("hudDetails/healthDimensions/x")), 
  thick(Gamedata::getInstance().getXmlInt("hudDetails/healthDimensions/y")), 
  increments(Gamedata::getInstance().getXmlInt("hudDetails/healthIncrement")),
  interval(Gamedata::getInstance().getXmlInt("hudDetails/healthInterval")),
  deltaTime(Gamedata::getInstance().getXmlInt("hudDetails/healthDeltaTime")),
